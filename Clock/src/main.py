...
def get_clock_pos(clock_dict, clock_hand, key):
    """Определяет координаты поворота стрелки"""
...
while True:
    ...
    # Рисуем круги по радиусу циферблата разных размеров.
    ...
    # Рисуем цыферблат механических часов.
    ...
    # Рисуем секундный индикатор по радиусу часов(арку).
